...
//        return getAllPlaylists(makePlaylistCursor(context, null, null));
        return MediaStoreUtil.INSTANCE.getAllPlaylists(context);
    }
...
//                }
//        ));
        return MediaStoreUtil.INSTANCE.getPlaylist(context, playlistId);
    }
...
//                }
//        ));
        return MediaStoreUtil.INSTANCE.getPlaylist(context, playlistName);
    }
...
//            cursor.close();
//        return playlist;
        return MediaStoreUtil.INSTANCE.getPlaylist(cursor);
    }
...
//            cursor.close();
//        return playlists;
        return MediaStoreUtil.INSTANCE.getAllPlaylists(cursor);
    }
/*
    @NonNull
...
//            return null;
//        }
        return MediaStoreUtil.INSTANCE.queryPlaylists(context, selection, values);
    }
}
...
package player.phonograph.foundation.time
...
object TimeInterval {
     ...
     */
    fun past(duration: Duration): Long = duration.toSeconds() * TimeUnit.MILLI_PER_SECOND

    /**
     * @return elapsed milli-second
     */
    fun recently(duration: Duration): Long = when (duration) {

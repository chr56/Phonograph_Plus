...
sealed class BaseLoader {
    ...
    protected fun List<SongEntity>.convertSongs(): List<Song> = mapNotNull(this@BaseLoader::convertSong)
    protected fun SongEntity?.convert(): Song? = this?.let(this@BaseLoader::convertSong)

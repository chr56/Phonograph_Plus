...
class PreferenceUtil5 private constructor(context: Context) {
    ...
    val generalTheme: Int
        get() = getThemeResFromPrefValue(mPreferences.getString(GENERAL_THEME, "auto"))
    ...
    val lastChangelogVersion: Int
        get() = mPreferences.getInt(LAST_CHANGELOG_VERSION, -1)

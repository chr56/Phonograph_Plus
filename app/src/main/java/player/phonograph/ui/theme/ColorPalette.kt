...
object ColorPalette {
    ...
    fun dynamicColors(context: Context) = intArrayOf(
        context.getColor(R.color.system_accent1_400),
        context.getColor(R.color.system_accent2_400),
        context.getColor(R.color.system_accent3_400),
        context.getColor(R.color.system_neutral1_500),
        context.getColor(R.color.system_neutral2_500),
    )

    @RequiresApi(Build.VERSION_CODES.S)
    fun allDynamicColors(context: Context) = arrayOf(
        intArrayOf(
            context.getColor(R.color.system_accent1_100),
            context.getColor(R.color.system_accent1_200),
            context.getColor(R.color.system_accent1_300),
            context.getColor(R.color.system_accent1_400),
            context.getColor(R.color.system_accent1_500),
            context.getColor(R.color.system_accent1_600),
            context.getColor(R.color.system_accent1_700),
            context.getColor(R.color.system_accent1_800),
            context.getColor(R.color.system_accent1_900),
        ),
        intArrayOf(
            context.getColor(R.color.system_accent2_100),
            context.getColor(R.color.system_accent2_200),
            context.getColor(R.color.system_accent2_300),
            context.getColor(R.color.system_accent2_400),
            context.getColor(R.color.system_accent2_500),
            context.getColor(R.color.system_accent2_600),
            context.getColor(R.color.system_accent2_700),
            context.getColor(R.color.system_accent2_800),
            context.getColor(R.color.system_accent2_900),
        ),
        intArrayOf(
            context.getColor(R.color.system_accent3_100),
            context.getColor(R.color.system_accent3_200),
            context.getColor(R.color.system_accent3_300),
            context.getColor(R.color.system_accent3_400),
            context.getColor(R.color.system_accent3_500),
            context.getColor(R.color.system_accent3_600),
            context.getColor(R.color.system_accent3_700),
            context.getColor(R.color.system_accent3_800),
            context.getColor(R.color.system_accent3_900),
        ),
        intArrayOf(
            // context.getColor(android.R.color.system_neutral1_0),
            context.getColor(R.color.system_neutral1_100),
            context.getColor(R.color.system_neutral1_200),
            context.getColor(R.color.system_neutral1_300),
            context.getColor(R.color.system_neutral1_400),
            context.getColor(R.color.system_neutral1_500),
            context.getColor(R.color.system_neutral1_600),
            context.getColor(R.color.system_neutral1_700),
            context.getColor(R.color.system_neutral1_800),
            context.getColor(R.color.system_neutral1_900),
            // context.getColor(android.R.color.system_neutral1_1000),
        ),
        intArrayOf(
            // context.getColor(android.R.color.system_neutral2_0),
            context.getColor(R.color.system_neutral2_100),
            context.getColor(R.color.system_neutral2_200),
            context.getColor(R.color.system_neutral2_300),
            context.getColor(R.color.system_neutral2_400),
            context.getColor(R.color.system_neutral2_500),
            context.getColor(R.color.system_neutral2_600),
            context.getColor(R.color.system_neutral2_700),
            context.getColor(R.color.system_neutral2_800),
            context.getColor(R.color.system_neutral2_900),

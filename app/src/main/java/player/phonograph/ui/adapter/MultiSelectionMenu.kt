...
import player.phonograph.ui.actions.actionDeletePlaylists
...
import player.phonograph.ui.actions.actionSavePlaylists
...
fun <I> inflateMultiSelectionToolbarMenu(
    menu: Menu,
    context: Context,

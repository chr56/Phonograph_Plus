...
import com.kabouzeid.phonograph.helper.MusicProgressViewUpdateHelper;
import com.kabouzeid.phonograph.helper.PlayPauseButtonOnClickHandler;
import com.kabouzeid.phonograph.misc.SimpleOnSeekbarChangeListener;
import com.kabouzeid.phonograph.service.MusicService;
import com.kabouzeid.phonograph.ui.fragments.AbsMusicServiceFragment;
import com.kabouzeid.phonograph.util.MusicUtil;
import com.kabouzeid.phonograph.views.PlayPauseDrawable;
...
public class CardPlayerPlaybackControlsFragment extends AbsMusicServiceFragment implements MusicProgressViewUpdateHelper.Callback {
    ...
    private void setUpPlayPauseFab() {
        ...
        playPauseFab.setColorFilter(MaterialColorHelper.getPrimaryTextColor(getContext(), ColorUtil.isColorLight(fabColor)), PorterDuff.Mode.SRC_IN);

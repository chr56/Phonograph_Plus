...
-keepclassmembernames,allowoptimization,allowshrinking class player.phonograph.glide.artistimage.*Logics {public <methods>;}
-keepclassmembernames,allowoptimization,allowshrinking class player.phonograph.glide.audiocover.*Logics {public <methods>;}
-keepclassmembernames,allowoptimization,allowshrinking class player.phonograph.glide.*Request {public <methods>;}
-keepclassmembernames,allowoptimization,allowshrinking class player.phonograph.glide.*Target {public <methods>;}

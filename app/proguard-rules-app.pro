...
-keepclassmembernames,allowoptimization,allowshrinking class player.phonograph.mechanism.metadata.* extends player.phonograph.model.metadata.MetadataExtractor { public <methods>; }
